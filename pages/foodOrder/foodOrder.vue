	...
	<view class="food-order">
			...
			<view style="margin: 20rpx;">
				<view class="food-item">
					...
					<view class="detail-food">
						...
						<!-- <view class="title">用餐时间:{{reportDetail.create_datetime}}</view>
						<view class="title">菜品数量:{{reportDetail.item_count}}</view>
						<view class="title">所点菜品种类:{{reportDetail.type_count}}</view> -->
					</view>
				</view>
			</view>
			<view style="margin: 20rpx;">
				<view class="pay-item">
					<view style="font-weight: 700;width: 100%;text-align: center;">用餐详情</view>
					<view class="pay-food">
						<view class="message">
							<view class="title">菜品数量：</view>
							<view class="name">{{reportDetail.item_count}}道</view>
						</view>
						<view class="message">
							<view class="title">菜品类型：</view>
							<view class="name">{{reportDetail.type_count}}种</view>
						</view>
						<view class="message">
							<view class="title">用餐人数：</view>
							<view class="name">{{reportDetail.guest_count}}人</view>
						</view>
						<view class="message">
							<view class="title">点餐人数：</view>
							<view class="name">{{reportDetail.order_count}}人</view>
						</view>
				...
				<view class="pay-item">
					...
					<view class="pay-food">
						<view class="message">
							...
							<view class="name">商品总价：<text style="font-weight: 700;">{{(reportDetail.original_amount/100).toFixed(2)}}</text></view>
						</view>
						<view class="message">
							<view></view>
		...
		<view class="pay-btn">
			<view style="width: 50%;margin: 0 20rpx;">
				<u-button hover-class="none" :disabled="!reportDetail.membership"   :custom-style="{color:membercolor,fontWeight:'700',backgroundImage:'linear-gradient('+memberbutton+')'}"
				 type="primary"	shape="circle">会员卡支付</u-button>
			</view>
			<view style="width: 50%; margin: 0 20rpx;">
				<u-button hover-class="none" @click="pay" :custom-style="{color:paycolor,fontWeight:'700',backgroundImage:'linear-gradient('+paybutton+')'}" type="primary"
					shape="circle">支付</u-button>
			</view>

		</view>
		<u-popup mode="center" @close="handleTicket" v-model="ticketShow" width="90%" height="65%" border-radius="10" closeable>
			<view class="ticket-detail">
				...
				<scroll-view scroll-y style="width: 95%;height: 600rpx;border: 1px solid #d1a766;border-radius: 10rpx;">
					<uni-data-checkbox mode="list" selectedColor="#d1a766"  wrap multiple v-model="ticketValue" :localdata="ticketList" @change="change">
					</uni-data-checkbox >
				</scroll-view>
	...
	export default {
		...
		methods: {
			...
			pay() {
				...
				// uni.showModal({
				// 	title: '支付成功!',
				// 	content:'尊敬的顾客!这里有一份意见调查表,提交您宝贵的意见后我们将赠送您一份小礼品哦!',
				// 	confirmText:'去填写',
				// 	success(res) {
				// 		if(res.confirm){
				// 			uni.redirectTo({
