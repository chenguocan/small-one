	...
	<view>
		<view class="wrap">
			...
			<view class="icon_list">
				<view v-for="(item,index) in list" :key="index" class="box_icon" :style="{background:item.icon,'background-size':size}">
					<!-- 1 -->
				</view>
			</view>
			<view class="u-tabs-box" style="display: none;">



				<u-tabs-swiper style="background: #F1F2F2;" activeColor="#f29100" ref="tabs" :list="list" :current="current"
				 @change="change" :is-scroll="false" swiperWidth="750">

				</u-tabs-swiper>
			</view>
			<swiper style="display: none;" class="swiper-box" :current="swiperCurrent" @transition="transition" @animationfinish="animationfinish">
						...
						<view class="page-box">
							<view class="order" v-for="(res, index) in orderList[0]" :key="res.id">
								...
								<view class="top">
									...
									<view class="right">
										<view class="bottom">
											<view class="exchange btn">取消</view>
											<view class="evaluate btn btn">评价</view>
										</view>
									</view>
...
<style lang="scss" scoped>
	...
	.date {
		...
		padding: 25rpx 74rpx 69rpx 74rpx;
		display: flex;
    ...
    .box_icon:nth-child(1){
		margin-left: 28rpx;
	}
	.btn{
		margin-top: -56rpx;
	}
	// .icon_list:nth-of-type(1) .box_icon {
	// 	margin-left: 22rpx;
	// }
</style>
